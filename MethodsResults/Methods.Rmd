...
```
  ...
  *Measuring Discount Rate*. Discount rate was measured in a variety of ways, both with including all the participants and using only the participants who discounted consistently. A patience was measured using all participants. We created an three patience scores which was the proportion of all discounting questions in which participants chose the later-larger option. One of these patience scores was for speedup questions, one for time discounting, and one was an overall patience score including all questions. The indifference proportion, hyperbolic, exponential, and quasi-hyperbolic measures excluded participants who answered questions inconsistently.
  Indifference was created an indifference by dividing the indifference point by the later but larger payment. This measure ranges between 0 and 1 where 0 indicates no patience at all and 1 indicates absolute patience as described in Bartels & Urminsky, 2011. This was done individually for all 8 methods of measuring discounting. The methods for measuring the hyperbolic and exponential discount rates were done previously described, and done for all 8 methods individually. We created a quasi-hyperbolic score for each set of present and future payments (for a total 4 sets) with corresponding $\beta$ and $\delta$s.

  *Demographics*. Subjects reported their age, marital status, having children, political affiliation, weight in lbs, height in feet and inches, employment status, ethnicity, household income in the past 12 months, expected household income in the next 12 months, and whether English was their native language. Employment status, political affiliation, and marital status were all dummy coded. Participants who reported having children were asked their age when their children were born.

  *Political Interest*. Participants were asked whether they registered to vote in the 2016 presidential election, about their interest in the 2018 midterm election, which party had the majority in Congress, whether they donated to any candidate in the 2016 election, whether they would support a one time tax to support a music program, or if they would favor or oppose a government increase of the excise tax on fuel to protect the environment, their political ideology. Participants were coded as politically knowledgeable based on whether they could correctly answer which party has the majority in Senate. Participants who indicated that they registered to vote were asked whether they voted, and whether they voted in the election early.
  ...
  *Exlusion Criteria* pariticpants who answered any of the continuous questions with an answer greater than the mean + 3 standard deviations were excluded from analysis. All continuous questions were capped at 0 as a minimum answer.
